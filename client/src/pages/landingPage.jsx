...
export default function LandingPage(){
    ...
    return (
        <div className='h-screen '>
            ...
            {sessionStorage.getItem('token')==null && <div className='flex justify-center  text-lg' >
            <button className='bg-green-600  rounded-lg hover:bg-green-400 p-2 m-2' onClick={()=>{navigate('/Login')}}>Admin</button>
            <button className='bg-green-600  rounded-lg hover:bg-green-400 p-2 m-2' onClick={()=>{navigate('/clientLogin')}}>Client</button>
            </div> }
